// ============================================================================
// Loads BambooHR, Odoo and Zoho CRM reviews into Supabase.
//   node supabase/load_more_reviews.js
// ============================================================================

const fs = require('fs');
const path = require('path');
const { createClient } = require('@supabase/supabase-js');
const { buildReviews, BAMBOOHR, ODOO, ZOHO_CRM } = require('./generate_more_reviews.js');
