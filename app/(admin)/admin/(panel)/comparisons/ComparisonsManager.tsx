...
import { upsertComparison, deleteComparison } from "../../actions";
    ...
    <div className="space-y-4">
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          <DialogTrigger asChild>
            <Button onClick={startCreate}>
              <Plus className="h-4 w-4" /> Add Comparison
            </Button>
          </DialogTrigger>
      ...
      <div className="rounded-lg border bg-white card-shadow">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead>Software A</TableHead>
              <TableHead>Software B</TableHead>
